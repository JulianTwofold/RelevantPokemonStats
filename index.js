...
var allowUserInteraction = false; //Buttons shouldn't work while load isn't finished
...
var loadPokemonAmount = 52; //How many Pokemon should get loadet at the time?
...
function loadPokemons() {
    ...
    if (new Date().getTime() - startTimer.getTime() < 50) {
        for (var i = loadetPokemon; i < pokemons.length; i++) {
            createRow(pokemons[totalStatsOfPokemonId[i][0]]);
        }
